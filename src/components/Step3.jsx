        ...
        <div className="space-y-4">
            ...
            <div className="discord-inner-bg p-5 rounded-lg text-left success-border border border-gray-700/50">
                <div className="space-y-2">
                    <T i18nKey="success_title" className="text-[#23a55a] font-bold text-xl uppercase tracking-tight" as="h3" />
                    <T i18nKey="success_message" args={{ id: "111222333444555666" }} className="text-[#dbdee1] text-base leading-relaxed" as="p" />
