        ...
        <div className="space-y-4">
            ...
            <div className="discord-inner-bg p-5 rounded-lg text-left success-border border border-gray-700/50">
                <div className="space-y-2">
                    <h3 className="text-(--discord-success) font-bold text-xl uppercase tracking-tight">Success!</h3>
                    <p className="text-(--discord-text) text-base leading-relaxed">
                    ...
                    <div className="flex items-center pt-3 text-(--discord-accent) text-xs font-semibold">
